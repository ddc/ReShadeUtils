...
TechniqueSorting=Clarity,Curves,DPX,LumaSharpen,FXAA,SMAA,Cartoon,CA,Chromakey,LeiFx_Tech,ASCII,ColorMatrix,Colourfulness,Daltonize,Border,Deband,KNearestNeighbors,NonLocalMeans,BloomAndLensFlares,DepthHaze,AmbientLight,DisplayDepth,AdvancedCRT,AdaptiveSharpen,Emphasize,HDR,FilmGrain,EyeAdaption,MotionBlur,FilmicAnamorphSharpen,FilmGrain2,FilmicPass,CinematicDOF,Mode1,Mode2,Mode3,Layer,Levels,HQ4X,GlitchB,Crosshair,Depth3D,HighPassSharp,GaussianBlur,HSLShift,LiftGammaGain,LevelsPlus,LUT,Nightvision,Monochrome,AdaptiveFog,MultiLUT,RingDOF,MagicDOF,GP65CJ042DOF,MatsoDOF,MartyMcFlyDOF,LightDoF_AutoFocus,LightDoF_Far,LightDoF_Near,PPFX_Godrays,MagicBloom,Tint,ChromaticAberration,PerfectPerspective,PPFXBloom,StageDepth,PPFXSSDO,ReflectiveBumpmapping,Technicolor,Technicolor2,MXAO,Before,After,Nostalgia,TiltShift,Tonemap,TriDither,UIDetect,UIDetect_Before,UIDetect_After,UIMask_Top,UIMask_Bottom,Vibrance,Vignette,SurfaceBlur
