# Form implementation generated from reading ui file '/home/ddc/Workspaces/Python/Personal/ReshadeUtils/src/ui/config.ui'
#
...
class Ui_config(object):
    def setupUi(self, config):
        ...
        self.cancel_pushButton = QtWidgets.QPushButton(parent=config)
        ...
        self.game_name_lineEdit = QtWidgets.QLineEdit(parent=config)
        ...
        self.game_label = QtWidgets.QLabel(parent=config)
        self.game_label.setGeometry(QtCore.QRect(10, 10, 71, 16))
        self.game_label.setObjectName("game_label")
        self.ok_pushButton = QtWidgets.QPushButton(parent=config)
