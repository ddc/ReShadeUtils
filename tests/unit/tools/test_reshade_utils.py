...
class TestReshadeUtils:
    ...
    def test_check_and_download_new_reshade_version(self, remote_reshade_version_mock, download_reshade_mock, unzip_reshade_mock, qtobj, fake_data, db_session, log):
        remote_reshade_version_mock.return_value = (6, 0, 1)
        ...
        assert new_reshade_version == remote_reshade_version_mock.return_value
