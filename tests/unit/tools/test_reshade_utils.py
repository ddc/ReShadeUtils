...
class TestReshadeUtils:
    ...
    def insert_game(self, db_session, fake_game_data):
    ...
    def test_check_and_download_new_reshade_version(self, remote_reshade_version_mock, download_reshade_mock, unzip_reshade_mock, get_configs_mocks, qtobj, db_session, log):
